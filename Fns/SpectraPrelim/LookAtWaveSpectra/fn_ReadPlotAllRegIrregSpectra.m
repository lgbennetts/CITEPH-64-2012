...
if ~exist('TestName','var');     TestName= {'12','17'} ;end; %'14' '2','14'
...
[SnA1,periodsA1] = fn_ReadandCombineSpectra(conc,TestName{1},Tp,probes);
[SnA2,periodsA2] = fn_ReadandCombineSpectra(conc,TestName{2},Tp,probes);
