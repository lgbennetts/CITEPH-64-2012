...
if ~exist('probeiR','var'); probeiR= 10 ;end; 
if ~exist('probeiT','var'); probeiT= 11 ;end;%probes= 1:20 ;end; 
...
Lab = ['39% Concentration ', WaveType ,'Reflection Probe ', num2str(probeiR),' (min:', t0str,' [s], ',t1str ' [s])'];
ipR1 = plot(Periods1,SnS1,'-r','DisplayName',Lab,'LineWidth',1);       

t0str = num2str(Times1(1));
t1str = num2str(Times1(2));
Lab = ['39% Concentration ', WaveType ,'Transmission Probe ', num2str(probeiT),' (min:', t0str,' [s], ',t1str ' [s])'];
