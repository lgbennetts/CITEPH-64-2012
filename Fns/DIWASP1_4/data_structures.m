...
% ID.layout        layout of the sensors - x,y,z in each column. [TW: 20130717] ie, [ [x1;y1;z1],...,[x_N;y_N;z_N] ] 
%                    x and y from arbitrary origin and z measured upwards from seabed (m)
% ID.datatypes     sensor type. Enter as cell list: e.g. { {'elev' 'pres'} } [TW: 20130717: added extra pair of {}].
%		   Currently supported:
