...
disp(['Fourier spectrum ' int2str(Sample.Nfilt) ' freqs'])
...
for i = 2:Sample.Nfilt
    ...
    [Rm, Tm, Rp, Tp, v_vec, u_vec, Res_mat.k0{i}, weight_0, x_lim] = ...
    fn_MultiMode_MultiFloe(...
    [Param.rho_0 Param.rho Param.nu Param.E ...
    ...
    %%% Solution - wave tank
    [Res_mat.Amp_1P{i}, Res_mat.Amp_1M{i}, Res_mat.Amp_3P{i}, ...
        Res_mat.Amp_3M{i}] = ...
    Wavetank3D_solver(...
    Sample.Amps_f(i), Res_mat.k0{i}, weight_0, v_vec, Rm, Tm, Rp, Tp, ...
    TankDim(2),TankDim(3), [0 x_lim TankDim(1)], 2*pi*Sample.f(i), ...
    Param.N-1, size(u_vec,2)-1, size(u_vec,2) - Param.Mev, Rb(i), 1);
end
close(h_waiting_bar)